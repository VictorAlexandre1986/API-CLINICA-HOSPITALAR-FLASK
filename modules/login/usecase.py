...
class LoginUseCase:
    ...
    def atualizar_login(self,usuario:str, senha:str, update_create: datetime):
        return self.login_repository.atualizar_login(id, usuario, senha, update_create=datetime.utcnow)